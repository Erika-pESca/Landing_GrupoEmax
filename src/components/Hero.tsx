...
export const Hero: React.FC = () => {
  return (
    <section className="relative pt-28 pb-10 md:pt-36 md:pb-14 overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            {/* Insignia superior */}
            <div className="inline-flex flex-wrap sm:flex-nowrap items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-slate-900/90 border border-slate-700/80 text-cyan-300 text-[11px] sm:text-xs font-semibold mb-5 sm:mb-6 shadow-xl backdrop-blur-md hover:border-cyan-500/50 transition-all">
              <span className="flex h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-cyan-400 animate-ping"></span>
            ...
            {/* Subtítulo */}
            <p className="text-base sm:text-xl text-slate-300 font-normal leading-relaxed mb-6 sm:mb-8 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto mb-8 sm:mb-10">
              ...
              <a
                href="#simulador"
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3.5 sm:py-4 rounded-xl font-semibold text-sm sm:text-base text-slate-200 bg-slate-800/90 hover:bg-slate-700/90 border border-slate-700 hover:border-slate-600 transition-all duration-200 text-center backdrop-blur-sm"
              >
            ...
            <div className="pt-6 border-t border-slate-800/80 w-full grid grid-cols-3 gap-2 sm:gap-4 text-left">
              <div>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-white tracking-tight">
                  Hasta 40%
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm text-slate-400 font-medium leading-tight">
                  Ahorro medio en factura
                </p>
              </div>

              <div>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-emerald-400 tracking-tight">
                  0 €
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm text-slate-400 font-medium leading-tight">
              ...
              <div>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-cyan-400 tracking-tight">
                  +2.800
                </p>
                <p className="text-[10px] sm:text-xs md:text-sm text-slate-400 font-medium leading-tight">
                  Hogares y empresas
